...
const importWasmModules = async () => { await postCoreReadyFramePromise; const wasmModulesUrl = `./host/${RUNTIME_URLS.WASM_MODULES_URL.replace(/^\.\//, "")}`; return import(wasmModulesUrl); };
